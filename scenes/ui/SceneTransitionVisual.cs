...
public partial class SceneTransitionVisual : CanvasLayer
{
    ...
    [Export] private float AnimationLength = 1.0f;

    [Export] private Curve AnimationCurve;
    ...
    public override void _Process(double delta)
    {
        ...
        if (_time >= _animationLength / 2) { EmitSignal(SignalName.Halfway); }
    ...
    private void Start(float length = Mathf.Inf)
    {
        ...
        ColorRect.Color = (Game.Instance.PlayerData.InFuture) ? Colors.Black : Colors.White;
